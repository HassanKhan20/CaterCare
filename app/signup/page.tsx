  ...
  return (
    <main className="cc-page cc-page-narrow" style={{ maxWidth: 460 }}>
      ...
      <div style={{ marginTop: 40 }}>
        ...
        <h1 className="cc-page-title" style={{ fontSize: 'clamp(36px, 4vw, 52px)', marginTop: 24 }}>
          Join Catercare.
        </h1>
        <p className="cc-page-sub">Order food, cook from home, or deliver — pick how you start.</p>
        ...
        >
          By creating an account you agree to our terms. We&apos;ll never sell your info.
        </p>
      </div>
    </main>
  );
